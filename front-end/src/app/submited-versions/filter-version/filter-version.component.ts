...
export class FilterVersionComponent implements OnInit{
  ...
  sort = [
    ...
    { name: 'Created at (Oldest)', value: 'created_at,ASC' },
    { name: 'Created at (Newest)', value: 'created_at,DESC' },
  ];
  ...
  async ngOnInit() {
    ...
    this.submissions = await this.submissionService.getSubmissionsByInitiativeId(this.params.id, null, null, null, false);
